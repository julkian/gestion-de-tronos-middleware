...
},{"./homeController":14}],16:[function(require,module,exports){
'use strict';
...
},{"../../../tmp/templates":37,"../directives":29,"../resources":34,"../services":36,"./app.config":10,"./app.config.routes":11,"./app.constants":12,"./app.controller":13,"./home":15,"./login":17,"./login/registration-user":19,"./spinner":21,"./winDialog":23}],17:[function(require,module,exports){
'use strict';
...
},{"./loginController":18}],18:[function(require,module,exports){
'use strict';
...
module.exports =
  angular.module('app.login.registration',  [])
    .controller('registrationController', require('./registrationController'));

},{"./registrationController":20}],20:[function(require,module,exports){
'use strict';
...
module.exports =
  angular.module('app.spinner',  [])
    .controller('spinnerController', require('./spinnerController'));

},{"./spinnerController":22}],22:[function(require,module,exports){
'use strict';
...
module.exports =
  angular.module('app.win',  [])
    .controller('winController', require('./winController'));

},{"./winController":24}],24:[function(require,module,exports){
'use strict';
...
},{"./barracks/barracks.component":25,"./families/families.component":26,"./gambling-hall/gambling-hall.component":27,"./houses/houses.component":28,"./market/market.component":30,"./septon/septon.component":31}],30:[function(require,module,exports){
'use strict';
...
},{"./app":16,"./directives":29,"./resources":34,"./services":36,"angular":7,"angular-animate":1,"angular-aria":2,"angular-material":3,"angular-messages":4,"angular-ui-router":6,"ngResource":5,"satellizer":8,"underscore":9}],33:[function(require,module,exports){
...
},{"./game-resources/game.resources":33,"./users-resources/user.resources":35}],35:[function(require,module,exports){
...
module.exports = angular.module("templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("app/layout.html","<div layout=\"column\" flex=\"\"><md-toolbar layout=\"row\" layout-align=\"start center\"><md-button layout=\"row\" layout-align=\"center center\" hide-sm=\"\" class=\"toolbar-button\" aria-label=\"Settings\" ng-click=\"app.toggleRightSidebar()\"><i class=\"material-icons\">menu</i></md-button><md-button layout=\"row\" layout-align=\"center center\" hide-gt-sm=\"\" ng-click=\"app.toggleItemsList()\" aria-label=\"Menu\"><i class=\"material-icons\">menu</i></md-button></md-toolbar><md-content ng-if=\"game\" style=\"background-color: gainsboro\" flex=\"\" class=\"md-padding page-content\"><div ui-view=\"\"></div></md-content></div><md-sidenav md-component-id=\"left\" class=\"md-whiteframe-z2 md-sidenav-left\"><md-toolbar><md-toolbar class=\"md-warn\" layout=\"row\" layout-align=\"center center\"><i flex=\"30\" layout=\"row\" layout-align=\"end center\" class=\"material-icons md-60\">account_circle</i><md-menu md-offset=\"0 40\"><md-button layout=\"row\" layout-align=\"center center\" class=\"capitalize\" ng-click=\"$mdOpenMenu()\" aria-label=\"Open menu\"><span>{{app.currentUserName}}</span> <i class=\"material-icons\">keyboard_arrow_down</i></md-button><md-menu-content width=\"3\"><md-menu-item><md-button ng-click=\"app.logout()\">Log out</md-button></md-menu-item></md-menu-content></md-menu></md-toolbar></md-toolbar><section><md-list><div class=\"md-list-item-text\" layout-margin=\"\"><h3>How to play</h3><h4>About the game</h4><p>Management of Thrones is a management game where the player represents a newborn house. The objective is to defeat all the families of the seven Kingdoms and claim the realm.</p><h4>Resources</h4><h5>Gold</h5><p>Gold is needed to build and level up the buildings that will help you during the game. As in real life the more gold, the better.</p><h5>Soldiers</h5><p>Soldiers are the ones that will make your dirty work. You can lead a number of soldiers to battle and try to defeat a family with them. You can train soldiers once your barracks have been built.</p><h4>Buildings</h4><h5>Houses</h5><p>Houses are, obviously, where all the people in your realm lives. As you level up your houses, more people will come to live. As more people pays taxes, your gold income will increment. Leveling houses will make your gold ratio bigger.</p><h5>Barraks</h5><p>Build barraks to train your inhabitants. Once you build them, you will have soldiers. Training a soldier costs 10 gold.</p><h5>Septon</h5><p>Your house believes in the seven Gods, and they will help you if you have faith (and gold). You can pay a tribute to the septon and the Gods will bless your soldiers in the next battle. Always remember that faith is not cheap.</p><h5>Gambling hall</h5><p>Try your luck betting here! You can bet any amount of gold you have. You have 50% chance to win. If you win, you will double the amount you bet.</p><h5>Market</h5><p>Market will improve your economy. As you level up the market, the costs to fight against the different houses of the realm will be discounted.</p><h4>Battles</h4><p>Select any family to try to defeat it. Battles will cost you gold, depending on the targeted family. You can send any number of soldiers to battle, but you will not know how many you will need to win! If you do not win the battle, you will loose all your soldiers. If the rival house is defeated, some of them will not return home but at least half of them will.</p></div></md-list></section></md-sidenav>");
$templateCache.put("app/home/home.html","<div layout=\"row\"><div flex=\"100\" layout=\"column\" layout-align=\"center center\" class=\"layout-padding\"><div layout=\"row\" layout-wrap=\"\" style=\"width: 100%\"><div flex=\"50\" style=\"background-color: #f6dd8e\" layout=\"row\" layout-align=\"space-around center\"><div layout=\"column\" layout-align=\"center center\"><h1>Management of Thrones</h1><h2>Hold the Gold: House {{game.houseName}}</h2></div><div layout=\"column\" layout-align=\"start center\" class=\"md-list-item-text\"><h3 style=\"margin: 10px 0px 5px 0px;\"><strong>Gold</strong></h3><h4 style=\"margin: 5px;\">{{game.totalGold}}</h4><h3 style=\"margin: 10px 0px 5px 0px;\"><strong>Soldiers</strong></h3><h4 style=\"margin: 5px;\">{{game.soldiers}}</h4></div></div><div flex=\"50\" style=\"background-color: #f6dd8e\" layout=\"column\" layout-align=\"center center\"><gt-families></gt-families></div><gt-houses flex=\"50\"></gt-houses><gt-barracks flex=\"50\"></gt-barracks><gt-septon flex=\"33\"></gt-septon><gt-gambling-hall flex=\"33\"></gt-gambling-hall><gt-market flex=\"33\"></gt-market></div></div></div>");
$templateCache.put("app/login/login.html","<md-content class=\"loginColor\" flex=\"100\" layout=\"row\" layout-align=\"center center\"><form flex=\"20\" ng-submit=\"login.doLogin()\" method=\"post\"><md-content flex=\"\" layout=\"row\" layout-align=\"center center\" class=\"loginColor\"><h1 flex=\"100\" layout=\"row\" layout-align=\"center center\">Gestión de tronos</h1></md-content><div layout-gt-md=\"row\"><md-input-container flex=\"\"><label>Username</label> <input type=\"text\" ng-model=\"login.user.username\"></md-input-container></div><div layout-gt-md=\"row\"><md-input-container flex=\"\"><label>Password</label> <input type=\"password\" ng-model=\"login.user.password\"></md-input-container></div><div layout-gt-md=\"row\" layout-align=\"center\"><md-button type=\"submit\" class=\"md-raised md-accent\" flex=\"\">Login</md-button></div><div class=\"help\" flex=\"\" layout=\"row\" layout-align=\"center center\"><p>Don\'t have account? <a href=\"\" ng-click=\"login.doRegistration()\">Click here to create it.</a></p></div></form></md-content>");
$templateCache.put("app/spinner/spinner.html","<md-dialog id=\"plz_wait\" style=\"background-color:transparent;box-shadow:none\"><div layout=\"row\" layout-sm=\"column\" layout-align=\"center center\" aria-label=\"wait\"><md-progress-circular md-mode=\"indeterminate\"></md-progress-circular></div></md-dialog>");
$templateCache.put("app/winDialog/win.html","<md-dialog aria-label=\"Dialog Before fighting families\" flex=\"30\" layout-padding=\"\" ng-cloak=\"\"><md-dialog-content><h1>CONRATZ!</h1><h2>You defeated all the families!</h2><p>It was hard but you did it! You now are the rightful heir of the throne</p><p>Restart the game and try once again!</p></md-dialog-content><md-dialog-actions layout=\"row\"><md-button ng-click=\"win.restart()\">Restart</md-button></md-dialog-actions></md-dialog>");
$templateCache.put("directives/barracks/barracks.dialog.html","<md-dialog aria-label=\"Dialog to buy soldiers\" flex=\"50\" layout-padding=\"\" ng-cloak=\"\"><md-dialog-content><h2>Train some soldiers!</h2><h4>How many soldiers do you want to train?</h4><form name=\"trainForm\"><div layout-gt-md=\"row\"><md-input-container flex=\"\"><label>Soldiers</label> <input type=\"text\" pattern=\"[0-9]*\" name=\"soldiersInput\" ng-model=\"training.soldiersToTrain\" required=\"\"></md-input-container></div></form></md-dialog-content><md-dialog-actions layout=\"row\"><md-button md-autofocus=\"\" class=\"md-primary md-raised\" ng-disabled=\"trainForm.$invalid\" ng-click=\"trainSoldiers()\">Train</md-button><md-button ng-click=\"cancel()\">Cancel</md-button></md-dialog-actions></md-dialog>");
$templateCache.put("directives/barracks/barracks.html","<md-card style=\"position: relative; height: 300px;\"><div flex=\"\" layout=\"column\" layout-align=\"center center\" class=\"overlay-card\" ng-if=\"!game.buildings.barracks\"><md-card-content style=\"color:#fafafa\"><h2>Barracks</h2><p>Start building to train soldiers and prepare for fight!</p></md-card-content><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < barracks.barracksCost\" class=\"md-primary md-raised\" ng-click=\"barracks.buyBarracks()\">Build (cost {{barracks.barracksCost}})</md-button></div><md-card-title ng-if=\"game.buildings.barracks\"><md-card-title-text><span class=\"md-headline\">Barracks</span></md-card-title-text><md-card-title-media><div class=\"md-media-lg card-media\"><img ng-src=\"http://media.moddb.com/images/articles/1/167/166075/auto/pic1.png\"></div></md-card-title-media></md-card-title><md-card-content ng-if=\"game.buildings.barracks\">Train soldiers.</md-card-content><md-card-actions layout=\"row\" layout-align=\"end center\" ng-if=\"game.buildings.barracks\"><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < barracks.soldierCost\" class=\"md-primary md-raised\" ng-click=\"barracks.showCreateSoldiersDialog()\">train (cost {{barracks.soldierCost}} per soldier)</md-button></md-card-actions></md-card>");
$templateCache.put("directives/families/families.afterFighting.dialog.html","<md-dialog aria-label=\"Dialog Before fighting families\" flex=\"30\" layout-padding=\"\" ng-cloak=\"\"><md-dialog-content ng-if=\"playerWon\"><h2>You defeated the house {{familyName}}</h2><p>Your army crushed your enemy. As a result of the battle, {{soldiersLost}} soldiers did not return home from battlefield</p></md-dialog-content><md-dialog-content ng-if=\"!playerWon\"><h2>You loose the battle against the house {{familyName}}</h2><p>As you see battlefield you know you underestimated the enemy. Your army were outnumbered</p><p>The soldiers that fought in the battlefield will never return home. And that is your fault.</p></md-dialog-content><md-dialog-actions layout=\"row\"><md-button ng-click=\"cancel()\">Close</md-button></md-dialog-actions></md-dialog>");
$templateCache.put("directives/families/families.beforeFighting.dialog.html","<md-dialog aria-label=\"Dialog After fighting families\" flex=\"50\" layout-padding=\"\" ng-cloak=\"\"><md-dialog-content><h2>Prepare to fight against the house {{familyName}}</h2><h4>Fight against this house will cost you {{familyGoldCost}} gold. How much soldires will you send?</h4><form name=\"beforeFightForm\"><div layout-gt-md=\"row\"><md-input-container flex=\"\"><label>Soldiers</label> <input type=\"text\" pattern=\"[0-9]*\" name=\"soldiersInput\" ng-model=\"beforeFight.soldiersToRisk\" required=\"\"></md-input-container></div></form></md-dialog-content><md-dialog-actions layout=\"row\"><md-button md-autofocus=\"\" class=\"md-primary md-raised\" ng-disabled=\"beforeFightForm.$invalid\" ng-click=\"fight()\">Fight</md-button><md-button ng-click=\"cancel()\">Cancel</md-button></md-dialog-actions></md-dialog>");
$templateCache.put("directives/families/families.html","<h3>Families</h3><div layout=\"row\" layout-align=\"center center\" layout-wrap=\"\"><div flex=\"25\" ng-repeat=\"family in families.families track by $index\"><md-button align=\"center\" ng-if=\"!game.familiesDefeated[family.NAME]\" style=\"margin-bottom: 5%; width: 125px\" class=\"md-raised\" ng-click=\"families.showBeforeFightDialog(family.NAME)\"><img width=\"25px\" align=\"center\" ng-src=\"/site/assets/images/{{family.NAME}}.png\">{{family.NAME}}</md-button><md-button class=\"md-raised\" disabled=\"true\" style=\"margin-bottom: 5%; background-color: rgba(255, 0, 13, 0.7); font-weight: bold; width: 125px\" ng-if=\"game.familiesDefeated[family.NAME]\"><img width=\"25px\" align=\"center\" ng-src=\"/site/assets/images/{{family.NAME}}.png\"><s>{{family.NAME}}</s></md-button></div></div>");
$templateCache.put("directives/gambling-hall/gambling-hall.html","<md-card style=\"position: relative; height: 300px;\"><div flex=\"\" layout=\"column\" layout-align=\"center center\" class=\"overlay-card\" ng-if=\"!game.buildings.gamblingHall\"><md-card-content style=\"color:#fafafa\"><h2>Gambling Hall</h2><p>Try your luck betting here!</p></md-card-content><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < gamblingHall.gamblingHallCost\" class=\"md-primary md-raised\" ng-click=\"gamblingHall.buyGamblingHall()\">Build (cost {{gamblingHall.gamblingHallCost}})</md-button></div><md-card-title><md-card-title-text ng-if=\"game.buildings.gamblingHall\"><span class=\"md-headline\">Gambling Hall</span></md-card-title-text><md-card-title-media ng-if=\"game.buildings.gamblingHall\"><div class=\"md-media-lg card-media\"><img ng-src=\"https://s-media-cache-ak0.pinimg.com/736x/8d/f0/5f/8df05fd9b10f7c01d0fc12bdc85383ec.jpg\"></div></md-card-title-media></md-card-title><md-card-content ng-if=\"game.buildings.gamblingHall\"><md-input-container class=\"md-block\" flex-gt-sm=\"\"><label>All or nothing</label> <input type=\"number\" min=\"0\" ng-model=\"gamblingHall.bet\"></md-input-container></md-card-content><md-card-actions layout=\"row\" layout-align=\"end center\" ng-if=\"game.buildings.gamblingHall\"><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < gamblingHall.bet || !gamblingHall.bet\" class=\"md-primary md-raised\" ng-click=\"gamblingHall.onClick($event)\">Bet</md-button></md-card-actions></md-card>");
$templateCache.put("directives/market/market.html","<md-card style=\"position: relative; height: 300px;\"><div flex=\"\" layout=\"column\" layout-align=\"center center\" class=\"overlay-card\" ng-if=\"!game.buildings.market\"><md-card-content style=\"color:#fafafa\"><h2>Market</h2><p>Start building to improve the economy of your kingdom</p></md-card-content><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < market.marketCost\" class=\"md-primary md-raised\" ng-click=\"market.lvlUpMarket()\">Build (cost {{market.marketCost}})</md-button></div><md-card-title ng-if=\"game.buildings.market\"><md-card-title-text><span class=\"md-headline\">Market</span> <span class=\"md-subhead\">Level: {{game.buildings.market}}</span></md-card-title-text><md-card-title-media><div class=\"md-media-lg card-media\"><img ng-src=\"http://img09.deviantart.net/bb6b/i/2016/004/4/3/market_stall_1__png_by_fumar_porros-d9mq1j3.png\"></div></md-card-title-media></md-card-title><md-card-content ng-if=\"game.buildings.market\">Level up your market to make battles cost less. Actual discount: {{market.marketDiscount}}%</md-card-content><md-card-actions layout=\"row\" layout-align=\"end center\" ng-if=\"game.buildings.market\"><md-button md-no-ink=\"\" ng-if=\"!market.maxOut\" ng-disabled=\"game.totalGold < market.marketCost\" class=\"md-primary md-raised\" ng-click=\"market.lvlUpMarket()\">lvl up (cost {{market.marketCost}})</md-button><md-button md-no-ink=\"\" ng-if=\"market.maxOut\" ng-disabled=\"true\" class=\"md-primary md-raised\">Max level reached</md-button></md-card-actions></md-card>");
$templateCache.put("directives/houses/houses.html","<md-card style=\"position: relative; height: 300px;\"><div flex=\"\" layout=\"column\" layout-align=\"center center\" class=\"overlay-card\" ng-if=\"!game.buildings.houses\"><md-card-content style=\"color:#fafafa\"><h2>Houses</h2><p>Start building to have more people in your kingdom</p></md-card-content><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < houses.housesCost\" class=\"md-primary md-raised\" ng-click=\"houses.levelUpHouses()\">Build (cost {{houses.housesCost}})</md-button></div><md-card-title ng-if=\"game.buildings.houses\"><md-card-title-text><span class=\"md-headline\">Houses</span> <span class=\"md-subhead\">Level: {{game.buildings.houses}}</span></md-card-title-text><md-card-title-media><div class=\"md-media-lg card-media\"><img ng-src=\"https://s-media-cache-ak0.pinimg.com/236x/28/27/d3/2827d3b3a9da81d788a697265a8ab5fc.jpg\"></div></md-card-title-media></md-card-title><md-card-content ng-if=\"game.buildings.houses\">Level up your houses to have more people to steal to... I mean to pay taxes.</md-card-content><md-card-actions layout=\"row\" layout-align=\"end center\" ng-if=\"game.buildings.houses || game.buildings.houses === 20\"><md-button md-no-ink=\"\" ng-if=\"!houses.maxOut\" ng-disabled=\"game.totalGold < houses.housesCost\" class=\"md-primary md-raised\" ng-click=\"houses.levelUpHouses()\">lvl up (cost {{houses.housesCost}})</md-button><md-button md-no-ink=\"\" ng-if=\"houses.maxOut\" ng-disabled=\"true\" class=\"md-primary md-raised\">max level reached</md-button></md-card-actions></md-card>");
$templateCache.put("directives/septon/septon.html","<md-card style=\"position: relative; height: 300px;\"><div flex=\"\" layout=\"column\" layout-align=\"center center\" class=\"overlay-card\" ng-if=\"!game.buildings.septon\"><md-card-content style=\"color:#fafafa\"><h2>Septon</h2><p>Start building to ask for help to the seven Gods</p></md-card-content><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < septon.septonCost\" class=\"md-primary md-raised\" ng-click=\"septon.buySepton()\">Build (cost {{septon.septonCost}})</md-button></div><md-card-title ng-if=\"game.buildings.septon\"><md-card-title-text><span class=\"md-headline\">Septon</span></md-card-title-text><md-card-title-media><div class=\"md-media-lg card-media\"><img ng-src=\"https://s-media-cache-ak0.pinimg.com/564x/b7/aa/e9/b7aae923b72c557ba790d6110e4c8f95.jpg\"></div></md-card-title-media></md-card-title><md-card-content ng-if=\"game.buildings.septon\"><md-input-container class=\"md-block\" flex-gt-sm=\"\"><label>Tibute to the septon</label> <input type=\"number\" min=\"0\" ng-model=\"septon.tribute\"></md-input-container></md-card-content><md-card-actions layout=\"row\" layout-align=\"end center\" ng-if=\"game.buildings.septon\"><md-button md-no-ink=\"\" ng-disabled=\"game.totalGold < septon.tribute\" class=\"md-primary md-raised\" ng-click=\"septon.onClick($event)\">Do tribute</md-button></md-card-actions></md-card>");
$templateCache.put("app/login/registration-user/registrationUser.html","<md-dialog flex=\"33\"><md-toolbar><div class=\"md-toolbar-tools\"><h2 flex=\"flex\">Create user</h2></div></md-toolbar><md-dialog-content><md-content md-theme=\"dark\" layout=\"row\" layout-sm=\"column\" layout-align=\"center center\"><md-input-container flex=\"\"><label>userId</label> <input ng-model=\"registration.user.username\"></md-input-container><md-input-container flex=\"\"><label>Password</label> <input type=\"password\" ng-model=\"registration.password\"></md-input-container><md-input-container flex=\"\"><label>Repeat password</label> <input type=\"password\" ng-model=\"registration.passwordControl\"></md-input-container><md-input-container flex=\"\"><label>Family Name</label> <input type=\"text\" ng-model=\"registration.familyName\"></md-input-container></md-content></md-dialog-content><md-dialog-actions layout=\"row\"><span flex=\"\"></span><md-button class=\"btn1\" ng-click=\"registration.closeUserDetail()\">Close without create</md-button><md-button class=\"btn2\" ng-click=\"registration.saveUser()\" style=\"margin-right:20px;\">Create</md-button></md-dialog-actions></md-dialog>");}]);
},{}]},{},[32])